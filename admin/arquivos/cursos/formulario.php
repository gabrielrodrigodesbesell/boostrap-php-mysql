...
<div class="row">
    <div class="col-12 col-md-6">    
        <form id="form-cursos" enctype="multipart/form-data" method="POST" action="index.php?pagina=cursos/acoes&id=<?=$id?>" class="form-horizontal">
            <h2 class="display-5" id="titleform"><?=$titulo?></h2>
            <div class="form-group mb-3">
                <input id="titulo" type="text" value="<?=$buscaCurso->titulo?>" class="form-control" name="titulo" placeholder="Digite o titulo">
            </div>
            <div class="form-group mb-3">
                <input id="manchete" type="text" value="<?=$buscaCurso->manchete?>" class="form-control" name="manchete" placeholder="Digite a manchete">
            </div>
            <div class="form-group">
                <textarea id="conteudo" class="form-control" name="conteudo" placeholder="Digite o conteúdo"><?=trim($buscaCurso->conteudo)?></textarea>
            </div>
